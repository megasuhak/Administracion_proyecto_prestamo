...
$result = "";
$sql = "SELECT * FROM usuarios WHERE role = 'user' ORDER BY id_user DESC limit 30";
if (isset($_POST['consulta'])) {
	$q = Conexion::getConexion()->real_escape_string($_POST['consulta']);
	$sql = "SELECT * FROM usuarios WHERE nombre LIKE '%".$q."%' OR cedula LIKE '%".$q."%' OR email LIKE '%".$q."%' AND role = 'user'";
}
