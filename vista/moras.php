		...
		<div class="col-sm-12 col-md-9 col-lg-9 pt-5">
			<div class="container">
	          ...
	          <div class="row">
	            ...
	            <div class="col-sm-12 col-md-4 col-lg-4">
	                <input class="form-control mr-sm-2" type="search" name="buscar" placeholder="Buscar" id="buscador_moras" aria-label="Search">
	            </div>
	          </div>

	          <div id="datos_moras" style="overflow-X:scroll;" class="mb-5"></div>
